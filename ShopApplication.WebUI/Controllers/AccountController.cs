...
using ShopApplication.WebUI.Identity;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task< IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //send mail
                await _emailSender.SendEmailAsync(model.Email, "Hesabınızı onaylayınız", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:53869{callbackUrl}'> tıklayınız. </a>");
        ...
        public async Task< IActionResult> ForgotPassword(string Email)
        {
            ...
            //send mail
            await _emailSender.SendEmailAsync(Email, "Reset Password", $"Parolanızı yenilemek için  linke <a href='http://localhost:53869{callbackUrl}'> tıklayınız. </a>");
